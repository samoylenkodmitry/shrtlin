...
import shrtl.`in`.ui.components.colorpicker.AlphaBar
import shrtl.`in`.ui.components.colorpicker.HsvColor
import shrtl.`in`.ui.components.colorpicker.HueBar
import shrtl.`in`.ui.components.colorpicker.SaturationValueArea

// colorpicker = "0.7.0" # MIT https://github.com/godaddy/compose-color-picker/releases
...
fun ClassicColorPicker(
    ...
    val colorPickerValueState =
        rememberSaveable(stateSaver = HsvColor.Saver) {
